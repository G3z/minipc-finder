...
export const deviceSchema = z.object({
  ...
  scores: z.record(z.string(), nullableNumber),
  ...
  storage: z.record(z.string(), nullableNumber), ports: z.record(z.string(), nullableNumber),
  network: z.object({ ethModel: nullableString, ports: z.record(z.string(), nullableNumber), maxEth: nullableNumber, wifi6e: nullableBoolean, wifi6: nullableBoolean, wirelessSoc: nullableString }),
  ...
  physical: z.record(z.string(), nullableNumber), support: z.object({ warrantyYrs: nullableNumber, durabilityYrs: nullableNumber }),
